...
INSERT INTO users (ID, USERNAME, PASSWORD, FULLNAME, EMAIL, ENABLED, LASTPASSWORDRESETDATE) VALUES
  (4, 'morebodi', '$2a$10$NF02jBPEsaUC0pF7aMEu4.R.byOQTj/h4JB4I9.txNugJjqsSHgD.', 'morebodi modise', 'morebodi@mrmodise.com', 1,
   PARSEDATETIME('09-14-2017', 'dd-MM-yyyy'));

   INSERT INTO users (ID, USERNAME, PASSWORD, FULLNAME, EMAIL, ENABLED, LASTPASSWORDRESETDATE) VALUES
  (5, 'tester1', '$2a$10$Izh3b6YRcAmpZ3M5hxTYnuYWeMFed5pC2FUyf4mYbabn4axOyL8Tq', 'tester1 tester1', 'tester1@mrmodise.com', 1,
   PARSEDATETIME('06-06-2017', 'dd-MM-yyyy'));
...
INSERT INTO PHOTO (PHOTO_ID, CREATED, DESCRIPTION, IMAGE_NAME, LIKES, PHOTO_NAME, TITLE, USER_ID)
VALUES (2, PARSEDATETIME('06-06-2017', 'dd-MM-yyyy'), 'This is a description test', 'blog-img-2.jpg', 0, 'MODISE', 'MODISE pic', 4);
